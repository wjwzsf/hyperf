...
class JWT
{
    ...
    /**
     * User: wujiawei
     * DateTime: 2023/5/26 16:10
     * describe:自己新增的 解析jwt
     * @param $token
     * @param $secretKey
     * @param $algorithm
     * @return mixed
     * @throws Exception
     */
    public static function decodeJwtToken($token, $secretKey, $algorithm)
    {
        // 拆分JWT令牌
        ...
        try {
            // 验证签名
            JWT::verify("$header.$payload", base64_decode($signature), $secretKey, $algorithm);
